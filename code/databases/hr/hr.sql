...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50003 TRIGGER emp_salary_min_i BEFORE INSERT ON Employees FOR EACH ROW IF NOT new.salary > 0 THEN SIGNAL SQLSTATE '45000' SET message_text = "constraint emp_salary_min violated"; END IF */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50003 TRIGGER emp_salary_min_u BEFORE UPDATE ON Employees FOR EACH ROW IF NOT new.salary > 0 THEN SIGNAL SQLSTATE '45000' SET message_text = "constraint emp_salary_min violated"; END IF */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50003 TRIGGER jhist_date_interval_i BEFORE INSERT ON Job_history FOR EACH ROW IF NOT new.end_date > new.start_date THEN SIGNAL SQLSTATE '45000' SET message_text = "constraint jhist_date_interval violated"; END IF */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50003 TRIGGER jhist_date_interval_u BEFORE UPDATE ON Job_history FOR EACH ROW IF NOT new.end_date > new.start_date THEN SIGNAL SQLSTATE '45000' SET message_text = "constraint jhist_date_interval violated"; END IF */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
-- Dump completed on 2015-03-24  0:10:13
