...
CREATE VIEW BirthdayCzarView(FirstName, LastName, Age, BirthDate) AS
...
SELECT * FROM BirthdayCzarView WHERE Birthdate < TO_DATE('01_JAN-1976') AND Birthdate >= TO_DATE('01_JAN-1961');
	...
	-- The updated record is included in the results of the query. Either the view is nonmaterialized or the material view was updated by the UPDATE command. I would assume the former is the case.
